...
{
    [TestFixture]
    public class RandomForest_Test
    {
        [Test]
        public void Test()
        {
            RandomForestProgram._Main();
        }
    }
    ...
    class RandomForestProgram
    {
        ...
        private static Node createNode(int[] sample)
        {
            Node node = new Node();
            if (sample.Length == 1)
            {
        ...
        public static byte[] splitSample(Node node, int[] sample)
        {
        ...
        public static void makeLeftAndRightNodes(Node node, int[] sample)
        {
        ...
        public static void _Main()
        {
            ...
            Node topnode = createNode(randomSample);
